        ...
        if (Auth::check()) {
            ...
            if ($prod_check) {
                ...
                if (Cart::where('prod_id', $product_id)->where('user_id', Auth::id())->exists()) {
                    ...
                    $cartItem->save();
                    return response()->json(['status' => $prod_check->name  .  "Tambah ke Keranjang"]);
                }
            }
        } else {
    ...
    public function deleteProduct(Request $request)
    {
        ...
        if (Auth::check()) {
            ...
            if (Cart::where('prod_id', $prod_id)->where('user_id', Auth::id())->exists()) {
                ...
                $cartItem->delete();
                return response()->json(['status' => "Produk sukses di delete"]);
            }
        } else {
            return response()->json(['status' => "Login dahulu"]);
        }
    ...
    public function updateCart(Request $request)
    {
        ...
        if (Auth::check()) {
            ...
            if (Cart::where('prod_id', $prod_id)->where('user_id', Auth::id())->exists()) {
                ...
                $cart->update();
                return response()->json(['status' =>  "Jumlah Telah Di Update"]);
            }
        }
    }
